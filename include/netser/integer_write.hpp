...
//
    ...
    namespace detail {
        ...
        using discover_write_span_size = typename while_<
            CtRange,
            is_endianess_integer_field< typename deref_t<CtRange>::endianess >::template condition, // take the endianess of the first element.
            discover_write_span_size_body,
        ...
        template< typename CtLayoutIterator, typename AccessList, size_t SpanSize, size_t FieldWrittenBits, size_t CollectedBits, discover_case Case >
        ...
        struct discover_access {
            ...
            static constexpr bool can_grow_write  = (list_size<AccessList>::value) > 1 && front_size_or_zero< pop_front_t< AccessList > >::value*8 <= SpanSize;
    ...
    template< typename ZipIterator >
    NETSER_FORCE_INLINE
    constexpr auto int_<Signed, Bits, ByteOrder >::write_span( ZipIterator it )
    {
