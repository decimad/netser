...
namespace netser {
    ...
    namespace detail {
        ...
        struct placed_field_segment :
            public placed_field< Field, Offset >
        {
    ...
    private:
        ...
        struct get_field_struct< Index, IndexOffset, BitOffset, type_list< Layout0, LayoutsTail... > >
            : public std::conditional_t <
                (Index < IndexOffset + Layout0::count),
                typename Layout0::template get_field<Index - IndexOffset, BitOffset>,
    ...
    private:
        ...
        struct pop_struct< type_list<Type0, Types... > > {
            ...
            using result = std::conditional_t< child_pop_result::tail_empty,
    ...
    {
        constexpr layout_iterator(AlignedPtr ptr)
            : buffer_(ptr)
        {
        }
    ...
    struct layout_iterator< AlignedPtr, CtIterator, true >
    {
        ...
        layout_iterator(AlignedPtr ptr)
            : buffer_(ptr)
        {
        }
