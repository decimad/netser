...
namespace netser {
    ...
    public:
        ...
        constexpr mapping_iterator(Arg arg)
            : arg_(arg)
        {}
    ...
    public:
        ...
        constexpr mapping_iterator(RefType& ref)
            : ref_(ref)
        {}
    ...
    constexpr auto make_mapping_iterator(Arg&& arg) ->
        mapping_iterator< typename Mapping::begin, Arg >
    ...
    private:
        ...
        struct pop_struct< Type0, Tail... > {
            ...
            using result = std::conditional_t< nested_pop::tail_mapping::size == 0 /* empty mapping */,
                detail::mapping_pop_result< typename nested_pop::member, mapping_list< Tail... >, typename nested_pop::refstack >,
                detail::mapping_pop_result< typename nested_pop::member, mapping_list< typename nested_pop::tail_mapping, Tail... >, typename nested_pop::refstack >
            >;
        };
    ...
    public:
        ...
        struct get_mapping< Index, Current, Remaining0, Remaining... > : public std::conditional_t<
            (Remaining0::size + Current > Index), get_mapping_struct< Remaining0, Index-Current >, get_mapping< Index, Current + Remaining0::size, Remaining... > >
        {};
    ...
    struct mapped_member
    {
        ...
        using pop = detail::mapping_pop_result<
            typename nested_pop::member,
            std::conditional_t<
                is_empty_mapping<typename nested_pop::tail_mapping>(),
                mapping_list< >,
    ...
    namespace detail {
        ...
        struct exploded_array_member {
            ...
            using pop = mapping_pop_result<
                exploded_array_member,
                exploded_array_member< Class, Type, Size, Offset + 1, Ptr >,
...
#define MEMBER1( MemberAccess ) \
    ::netser::mem< decltype(::netser::detail::deduce_class(&MemberAccess)), std::remove_reference_t<decltype(::netser::detail::deduce_type(&MemberAccess))>, &MemberAccess >
#define MEMBER_ARRAY( Class, Member ) \
    ::netser::array_member< Class, decltype(::netser::detail::deduce_member_array_type(&Class::Member)), ::netser::detail::deduce_member_array_size(&Class::Member), &Class::Member >
