...
*/
    ...
    struct atomic_memory_access
    {
        ...
        static type read(AlignedPtr src)
        {
            ...
            return src.dereference<type, Offset/8>();
            //return *reinterpret_cast<const type*>(reinterpret_cast<const char*>(src.get()) + Offset / 8);
        }
        ...
        {
            static_assert(Offset % 8 == 0, "Bad Offset!");
            src.dereference<type, Offset / 8>() = value;
//            *reinterpret_cast<const type*>(reinterpret_cast<const char*>(dest) + Offset / 8) = value;
        }
    ...
    struct placed_atomic_memory_access : public AtomicMemoryAccess {
        ...
        static typename atomic_access::type read(AlignedPtr src)
        {
            ...
            return src.dereference<atomic_access::type, byte_offset>();
        }
        ...
        static void write(AlignedPtr dest, typename atomic_access::type value)
        {
            ...
            dest.dereference<atomic_access::type, byte_offset>() = value;
        }
    };
